...
//   // New useEffect to close chat if the selected user is no longer in connections (e.g., after disconnect)
//   useEffect(() => {
...
//     // Define a named listener to avoid duplicates
...
//         content: newMessage,
//       };
//       // Emit and wait for acknowledgment (optional)
//       socket.emit("sendMessage", message, (ack) => {
//         if (ack && ack.error) console.error("Send failed:", ack.error);
//       });
//       // Optimistic update (will be overwritten by receiveMessage if echoed)
//       setMessages((prev) => [...prev, message]);
//       setNewMessage("");
//     } catch (err) {
//       console.error("Error sending message:", err);
